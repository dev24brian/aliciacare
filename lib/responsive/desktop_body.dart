      ...
      leading: 
        Padding(
          padding: EdgeInsets.all(8.0),child: CircleAvatar(
            radius: 200.0,child: Image.asset('assets/logo.png',fit: BoxFit.fill,),

        ),),
        backgroundColor: Colors.green,
        title: const Center(child: Text('ALICIA CARE FOUNDATION',style: TextStyle(color: Color.fromARGB(255, 204, 11, 11),fontStyle: FontStyle.italic,fontWeight: FontWeight.bold,fontSize: 25),),),
      ),
      body:Expanded(
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: const Column(children: [
                    ...
                    Spacer(),
                    Text('ALICIA CARE FOUNDATION',style: TextStyle(color: Colors.white,fontSize: 15,fontWeight: FontWeight.bold,fontStyle: FontStyle.italic,),)
